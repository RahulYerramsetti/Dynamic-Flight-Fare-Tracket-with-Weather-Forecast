...
<html>
    ...
    <body background="r.jpg">
        ...
        <%
            ...
            goibibo.RootObject r = f.readJsonFromUrl("https://developer.goibibo.com/api/search/?app_id=xxxxxxxx&app_key=xxxxxxxxxxxxxxxxxxxxxxx&format=json&source=" + src + "&destination=" + dst + "&dateofdeparture=" + dat + "&seatingclass=E&adults=1&children=0&infants=0&counter=0");

            wweather.WRootObject t = f.fetchWeatherData("http://api.worldweatheronline.com/premium/v1/weather.ashx?key=xxxxxxxxxxxxxxxxxxxx"+dst+"&date=" + orgdat + "&format=Json");
